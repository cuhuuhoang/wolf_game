...
Role.create(role_id: 1, name: "Dân làng", description: "Dân làng không có bất kì chức năng đặc biệt nào cả, dân làng
theo phe dân");
Role.create(role_id: 2, name: "Ma sói", description: "Vào ban đêm, tất cả ma sói mở mắt và đi tìm những ma sói khác,
nếu không có ai mở mắt thì ma sói còn lại đang ở giữa, ma sói theo phe sói")
Role.create(role_id: 3, name: "Đạo tặc", description: "Ban đêm, đạo tặc có thể chọn cướp 1 lá bài từ người khác và đặt
...
Role.create(role_id: 4, name: "Tiên tri", description: "Ban đêm, tiên tri có thể nhìn lá bài nhân vật của người khác
hoặc là xem 2 lá bài ở giữa, nhưng không được di chuyển chúng. Tiên tri theo phe dân")
Role.create(role_id: 5, name: "Kẻ gây rối", description: "Vào ban đêm, Kẻ gây rối có thể tráo bài của 2 người khác mà
